DESCRIPTION = "AMD common kernel recipe for Linux 6.18.y"
...
python () {
    ...
    if major != "6.18":
        raise bb.parse.SkipRecipe("Skipping linux-amd_6.18.bb because major version is %s" % major)
}
...
INTERNAL_KERNEL_VERSION = "${@d.getVar('PREFERRED_VERSION_linux-amd') or '6.18.29'}"
...
SRC_URI = " \
    ...
    git://git.yoctoproject.org/yocto-kernel-cache;type=kmeta;name=meta;branch=yocto-6.18;destsuffix=yocto-kmeta \
"
...
# Common configs
require recipes-kernel/linux/linux-amd.inc
